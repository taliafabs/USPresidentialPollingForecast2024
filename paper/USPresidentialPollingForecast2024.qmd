...
The Times/Siena late October 2024 battleground poll uses a stratified sampling approach. This involves dividing the sampling frame of voters in the 7 battleground states into distinct strata based on characteristics such as state, party, race, gender, income, marital status, household size, and education level [@tswd]. Voters are then randomly selected from each stratnum to get a sample that is representative of likely voters in the seven key battleground states.
