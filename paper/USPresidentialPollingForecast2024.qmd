...
Our primary measurement task is to measure someone's opinion and translate it into who will win the 2024 U.S. presidential election. During presidential election cycles, different pollsters conduct polls that use different methodologies to translate public opinion inro who will win the election. But, before there can be a presidential polling dataset, there must be a measurement of public opinion [@tswd]. Surveys are a common instrument for measuring public opinion during presidential election cycles [@tswd].

During U.S. presidential and midterm election cycles, different pollsters conduct polls (surveys) to estimate support for Democratic, Republican, and third-party candidates and forecast the election results. Each poll aims to survey a population that is representative of likely voters and their opinions to predict the percentage of voters who will support each candidate and which candidate will win. Sampling and survey methodologies vary by pollster and we discuss the methodologies used by the Siena College/New York Times poll in [Appendix -@sec-pollster-meth]. 
