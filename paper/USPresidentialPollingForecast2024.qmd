...
Vice President Harris could outperform her polling averages if pollsters have over-corrected their 2016 and 2020 polling misses, and are now overestimating support for Trump. In the 2024 presidential election cycle, pollsters have used new statistical weighting techniques, including weighting by highest level of education and weighting on recalled vote to correct this [@silvergut]. Weighting by highest level of education aims to correct the nonresponse by giving respondents without a college degree more weight because they are less likely to respond to surveys and more likely to support Trump [@silvergut]. Weighting on recalled vote is used to ensure that the sample includes enough Trump voters by accounting for who survey respondents say they voted for in 2020 [@natecohn]. It on recalled vote aims to account for nonresponse bias by assuming that some respondents who say they voted for Biden in 2020 are actually Trump voters who do not report their 2020 vote accurately because they would rather say they voted for the winner [@silvergut]. More than two-thirds of polls in the month leading up to the 2024 U.S. presidential election were weighted on recalled vote [@natecohn]. @silvergut warns that these polls may have overcorrected 2016 and 2020 polling misses and overestimated support for Trump by incorrectly labeling respondents who said they voted for Biden in 2020 as Trump voters.

<<<<<<< HEAD
Former president Trump could win if pollsters have failed to correct the nonresponse bias again and are not surveying enough Trump voters, if enough voters are secretly uncomfortable with the idea of voting for a woman of color [@silvergut], or if weighting on recalled vote is not an overcorrection [@natecohn]. Some of "undecided" voters in 2024 presidential polls might actually be voters who support Trump because they are uncomfortable with a woman of color becoming President, and do not want to admit it [@silvergut]. @natecohn found that Trump's polling averages in two swing states, Arizona and Georgia, were worse in polls that weighted on recalled average than polls that did not. The effects of weighting by recalled vote on the accuracy of presidential polling estimates are yet to be seen.
=======
More than two-thirds of polls in the month leading up to the 2024 U.S. presidential election were weighted on recalled vote [@natecohn]. @silvergut warns that weighting by recalled vote can overcorrect the 2016 and 2020 polling misses by incorrectly labelling respondents who said they voted for Biden in 2020 as Trump voters. @natecohn warns that weighting by recalled vote can artificially cause poll results to look more like the actual results of the 2020 election.
>>>>>>> 962af13a8a8f2220c6144eb4fb6ce3f2aafaffbc

## Polling misses in 2016 and 2020 {#sec-pollmiss}

<<<<<<< HEAD
During the last two presidential election cycles, pollsters underestimated support for Trump. In 2016, they underestimated support for Trump in swing states, and in 2020, they overestimated Biden's margins of victory in the popular vote and in swing states \[\]

During the last two presidential election cycles, pollsters underestimated support for Trump due to nonresponse bias [@silve]

, predicted that Democratic nominee Hillary Clinton would win the 2016 election, and predict President Biden would win the 2020 popular vote and swing states by larger margins than he actually did. 88% of national polls overestimated support for Hillary Clinton in 2016, and 93% of national polls overestimated support for President Biden in 2020 [@kennedy2021]. @silvergut found that nonresponse bias was a major reason for this because pollsters did not reach enough Trump voters. Trump voters are more likely to be lower-information voters who distrust public institutions, which makes them less likely to respond to a survey [@silvergut].
=======
Polls underestimated support for former President Trump in the 2016 and 2020 presidential elections. In 2016, polls predicted a Clinton victory and in 2020, polls predicted a Biden victory by a larger margin. According to @silvergut, nonresponse bias was a major reason for this because pollsters did not reach enough Trump voters in 2016 and 2020. Trump voters are more likely to be lower-information voters who distrust public institutions, which makes them less likely to respond to a survey [@silvergut].
>>>>>>> 962af13a8a8f2220c6144eb4fb6ce3f2aafaffbc
...
Once the results of the 2024 U.S. presidential elections are in, our next step will be to compare the actual results to the polls and our own forecast and investigate why the polls were accurate or inaccurate. If the results are within the margin of error, we will know that the polls accurately predicted a tight race. If Harris or Trump wins in a landslide, by sweeping all seven battleground states, winning some battleground states by a wide margin, or flipping one of the losing candidate's safe or likely states, we will study more of the 2024 polling methodologies in depth

wins all the battleground states, some by a margin outside the margin of error, or flips any of the losing candidate's safe/likely states, wins the popular vote by a margin outside the MOE), we will take a deeper dive into 2024 polling methodologies, what was done to correct past polling misses, and why it failed.
...
The Times/Siena late October 2024 battleground poll has a target population of likely voters in the seven battleground states and a sampling frame of voters in the L2 list of registered voters that live in those states [@nytbattlegrounds].
...
The Times/Siena late October 2024 battleground poll uses a stratified sampling approach. This involves dividing the sampling frame of voters in the 7 battleground states into distinct strata based on characteristics such as state, party, race, gender, income, marital status, household size, and education level [@tswd]. Voters are then randomly selected from each stratum to get a sample that is representative of likely voters in the seven key battleground states.

The sample is drawn from the L2 voter file from @L2 and supplemented with phone number data from Marketing Systems Group to expand the survey's reach and contact as many likely voters as possible [@nytbattlegrounds].
