...
The Times/Siena late October 2024 battleground poll uses a response-rate-adjusted stratified sampling approach. Stratified sampling is a probability-based approach that involves dividing the sampling frame of voters in the seven battleground states into distinct strata [@tswd] based on statehouse district, party, race, gender, marital status, household size, turnout history, age and home ownership \[@nytbattlegrounds\]. Voters were then randomly selected from each strata to get a sample that is representative of likely voters in the seven battleground states. Weighting was used to try to correct the nonresponse bias that plagued 2016 and 2020 estimates for support for Trump [@nytbattlegrounds]. The sample was adjusted for unequal probability of selection via stratnum, to account for the probability that a respondent will actually vote in the 2024 eletion, and to math targets for the likely composition of the electorate [@nytbattlegrounds].
